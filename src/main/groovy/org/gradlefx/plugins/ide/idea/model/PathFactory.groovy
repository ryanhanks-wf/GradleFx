...
class PathFactory extends org.gradle.plugins.ide.idea.model.PathFactory {
...
//    }
    ...
    protected static String relativePathToURI(String relpath) {
        if (relpath.endsWith('.swc')) {
            return 'jar://' + relpath + '!/';
        } else {
            return 'file://' + relpath;
        }
